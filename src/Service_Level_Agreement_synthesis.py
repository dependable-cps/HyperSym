...
def Service_Level_Agreement_Synthesis(Formula,Num,dts_file_location,method):
        ...
        cdts.plot([], [], 'Service_Level_Agreement_Problem')
        cdts.plot(strategy, [], 'Service_Level_Agreement_solution')
        solver.pop()
