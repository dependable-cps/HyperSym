...
def Non_Interference_Synthesis(Formula,Num,dts_file_location,method):
        ...
        print(" Non Interferenece solved in " + str(end - start) + " sec")
        strategy = []
        strategy1 = []
        if res == sat:
            m = solver.model()
        ...
        cdts.plot([], [], 'Non_Interference_Problem')
        cdts.plot(strategy,strategy1, 'Non_Interference_solution')
        solver.pop()
