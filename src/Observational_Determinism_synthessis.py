...
def Observational_Determinism_Syn(Formula,Num,dts_file_location,method):
        ...
        cdts.plot([], [], 'Observational_Determinism_problem')
        cdts.plot(strategy, strategy1, 'Observational_Determinism_solution')
        solver.pop()
