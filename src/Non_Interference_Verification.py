...
import random
from z3 import *
from src.parser import check_Non_Interference
import time
import re
...
def Non_Interference_verifi(Formula,Num,dts_file_location,method):
        ...
        check_Non_Interference(Formula)
        ...
        solver.add(
            And(
                ...
                [Not(l2[0][labelToNum['Ss']])] +
                [Not(l1[0][labelToNum['Ss']])] +
                [Not(Implies(And([l1[0][labelToNum['Ss']] != l2[0][labelToNum['Ss']]]),
                ...
                [Not(
                    l1[T - 1][labelToNum['G']] == l2[T - 1][labelToNum['G']])] +  # goal state should be same at the end
                [Not(Exists(
        ...
        print("Non Interference solved in " + str(end - start) + " sec")
