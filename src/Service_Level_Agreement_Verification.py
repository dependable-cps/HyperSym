...
import random
from z3 import *
from src.parser import check_Service_L_A
import time
import re
...
def Service_Level_Agreement_Verifi(Formula,Num,dts_file_location,method):
        ...
        original_formula = And(
                ...
                + [l2[0][labelToNum['Ss']]]
                + [l1[0][labelToNum['Ss']]]
                + Or([l1[t][labelToNum['G']] for t in range(T)])   # Negate the goal state in path1
        ...
        print("Service Level Agreement solved in " + str(end - start) + " sec")
