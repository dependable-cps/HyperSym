...
def Mutation_Testing_Synthesis(Formula,Num,dts_file_location,method):
...
"""
        ...
        cdts.plot([], [], 'mutation_testing_Problem')
        cdts.plot(strategy,strategy1, 'mutation_testing_solution')
        solver.pop()
