...
import random
from z3 import *
from parser import check_Linearizability
import time
import re
...
def Linearizability_Syn(Formula,Num,dts_file_location,method):
    ...
    Or(
        ...
        cdts.plot([], [], 'Linearizability_Problem')
        cdts.plot(strategy,strategy1, 'Linearizability_solution')
        solver.pop()
